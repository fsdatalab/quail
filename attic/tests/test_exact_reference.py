"""Verification battery for the exact reference solvers (paper sec. 10.5
step 1 and the sec. 11 checklist), moved to the attic with the solvers.
The toy model/device helpers are duplicated from tests/test_exact.py so
neither suite reaches across directories."""
...
from attic.theory.manifest import emit
from attic.theory.reference.offline import solve_offline
from attic.theory.reference.online import solve_online
