...
`reports/make_sol_quailb.py` applies this model to the 32 default queries
at sf=0.1 on Qwen3 4B fp8 and Qwen3 32B fp8. It uses document lengths,
prompt lengths, and active ground-truth labels.
