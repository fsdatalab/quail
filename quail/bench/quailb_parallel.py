...
image = build_worker_image(local_python_sources=("quailb",))
sglang_image = build_worker_image(
    local_python_sources=("quailb",), runtime_package="sglang==0.5.18")
...
def run_query_family(
    ...
    from quailb.queries import query_family_name
...
def _merge_suites(parts, query_ids, run_label, started, elapsed,
    ...
    from quailb.scoring import summarize_queries
