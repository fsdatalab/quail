...
image = build_worker_image(local_python_sources=("quail_bench",))
sglang_image = build_worker_image(
    local_python_sources=("quail_bench",), runtime_package="sglang==0.5.18")
...
def run_query_family(
    ...
    from quail_bench.queries import query_family_name
...
def _merge_suites(parts, query_ids, run_label, started, elapsed,
    ...
    from quail_bench.scoring import summarize_queries
