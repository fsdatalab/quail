...
image = (
    ...
    .env({# vLLM inspects the model architecture in a fresh Python
          # subprocess at every config creation (~11 s). It caches the
          # result under VLLM_CACHE_ROOT/modelinfos; keeping that on
          # the kernel-cache volume makes it run once ever, not once
          # per container.
