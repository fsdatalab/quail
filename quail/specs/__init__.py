...
from .diffusion_gemma_26b import (
    ...
    DIFFUSION_GEMMA_26B_FP8_CANVAS1,
...
MODELS = {QWEN3_4B_FP8.name: QWEN3_4B_FP8,
         ...
         DIFFUSION_GEMMA_26B_FP8_CANVAS1.name: DIFFUSION_GEMMA_26B_FP8_CANVAS1}
...
__all__ = ["ACT_BYTES_PER_HIDDEN", "DeviceSpec", "ModelSpec", "Precision",
           ...
           "DIFFUSION_GEMMA_26B_FP8_CANVAS32",
           "DIFFUSION_GEMMA_26B_FP8_CANVAS8", "DIFFUSION_GEMMA_26B_FP8_CANVAS1",
