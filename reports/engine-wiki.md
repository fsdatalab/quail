...
The planner reads no calibration constant: plan choices compare
token counts, and plan ranking prices Work records with counted
model constants against the device datasheet (`planner/sol.py`).
